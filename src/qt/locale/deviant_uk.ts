...
<context>
    ...
    <message>
        ...
        <translation>Це ваші Deviant адреси для отримання платежів. Для кожної транзакції рекомендується використовувати нову адресу одержувача.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Deviant зараз закриється, щоб завершити процес шифрування. Пам'ятайте, що шифрування гаманця не може повністю захистити ваші DEV'и від крадіжки зловмисним програмним забезпеченням, що заражає ваш комп'ютер.</translation>
    </message>
    <message>
