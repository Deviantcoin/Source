...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Deviant address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Deviant addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Deviant addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Deviant Core help message to get a list with possible Deviant command-line options"));
