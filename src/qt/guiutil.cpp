...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("Deviant://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "Deviant:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Deviant-Qt") + " " + tr("version") + " " +
