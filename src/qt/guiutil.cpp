...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Deviant address (e.g. %1)").arg("da4NsP8KutrV24MDQyYnhtS7AuqPLhWFRQ"));
#endif
...
{
    // return if URI is not valid or is no Deviant: URI
...
void openConfigfile()
{
    ...
    /* Open deviant.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Deviant.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Deviant.lnk
