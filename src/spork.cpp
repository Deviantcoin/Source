...
// Deviant: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE) r = SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE") return SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE) return "SPORK_17_BAN_ZDEV_TRANSACTIONS_VERSION_1_IN_MAINTENANCE_MODE";
