...
Only requiring some minor changes is deviant.cpp.
...
Changes to deviant.cpp
----------------------
deviant.cpp is the entry point into deviant-qt, and as such, will require some minor modifications to provide hooks for
