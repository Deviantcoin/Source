...
[
  {
    ...
    winner: {
        address: addr,    (string) Deviant MN Address,
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Deviant (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Deviant (Fuzzbawls)
